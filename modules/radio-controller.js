    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        if (this.isRemote()) {
          ...
          const listeCommand = `ssh -f -p ${this.remoteProcessor.port} ${this.remoteProcessor.username}@${this.remoteProcessor.address} '/usr/bin/nc -u -l -p ${this.remoteProcessor.slavePort}  | /usr/bin/zstd -1 - -o ${cwd}/${filename}' `
